...
enum {
  ...
  sym_let = 33,
  sym__expression = 34,
  sym__basic_expression = 35,
  sym_variable_instance = 36,
  sym_string = 37,
  sym_string_content = 38,
  sym_interpolation = 39,
  sym_connection = 40,
  sym_key_value_pair = 41,
  sym_execute = 42,
  sym_query = 43,
  sym__sql = 44,
  sym_sql = 45,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 3:
      ...
      END_STATE();
    case 4:
      if (sym_escape_sequence_character_set_1(lookahead)) ADVANCE(19);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sql_repeat1, 2),
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sql_repeat1, 2), SHIFT_REPEAT(22),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sql_repeat1, 2), SHIFT_REPEAT(27),
  ...
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(26),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(28),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  ...
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(86),
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sql_content_repeat1, 2),
  [94] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sql_content_repeat1, 2), SHIFT_REPEAT(20),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(32),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(23),
  [111] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_connection_repeat1, 2), SHIFT_REPEAT(65),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_connection_repeat1, 2),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sql_content, 1),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_content, 1),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__nl, 1),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 6),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_instance, 1),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query, 2, .production_id = 1),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__sql, 4, .production_id = 4),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2, .production_id = 5),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_execute, 2, .production_id = 1),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sql, 4),
  [166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [168] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 4, .production_id = 3),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__sql, 2, .production_id = 2),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_connection, 4, .production_id = 6),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4, .production_id = 7),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_connection, 10, .production_id = 6),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_connection, 9, .production_id = 6),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_key_value_pair, 3, .production_id = 8),
