...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [64] = {.lex_state = 0},
  [65] = {.lex_state = 0, .external_lex_state = 13},
  [66] = {.lex_state = 0},
  [67] = {.lex_state = 0},
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2),
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__sql, 2),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__sql, 2), SHIFT_REPEAT(32),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__sql, 2), SHIFT_REPEAT(29),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(19),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(35),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(33),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(83),
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(82),
  [90] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(20),
  ...
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sql_content, 1),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_expression, 4, .production_id = 4),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(31),
  [127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [129] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_content, 1),
  [133] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2), SHIFT_REPEAT(45),
  ...
  [142] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sql_content_repeat1, 2), SHIFT_REPEAT(36),
  ...
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_instance, 1),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3),
  [157] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__connection_expression_repeat1, 2), SHIFT_REPEAT(60),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__connection_expression_repeat1, 2),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 6),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_expression, 7, .production_id = 4),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_execute_sql, 9, .production_id = 6),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression, 1, .production_id = 2),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 4, .production_id = 1),
