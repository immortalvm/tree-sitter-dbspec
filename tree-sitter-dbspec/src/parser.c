...
enum {
  ...
  sym_let = 23,
  sym__expression = 24,
  sym__basic_expression = 25,
  sym_variable_instance = 26,
  sym__connection_expression = 27,
  sym_name_value_pair = 28,
  sym_string = 29,
  sym_interpolation = 30,
  aux_sym_source_file_repeat1 = 31,
  aux_sym_source_file_repeat2 = 32,
  aux_sym_parameters_repeat1 = 33,
  aux_sym__connection_expression_repeat1 = 34,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(27),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(25),
  ...
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4),
  ...
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 1),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3),
  ...
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_expression, 4, .production_id = 3),
  [109] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(30),
  [116] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__connection_expression_repeat1, 2), SHIFT_REPEAT(51),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__connection_expression_repeat1, 2),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 4, .production_id = 1),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression, 1, .production_id = 2),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_expression, 7, .production_id = 3),
  ...
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_instance, 1),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 6),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(48),
