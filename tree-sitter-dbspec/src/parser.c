...
enum {
  ...
  sym_let = 25,
  sym__expression = 26,
  sym__basic_expression = 27,
  sym_variable_instance = 28,
  sym__connection_expression = 29,
  sym_name_value_pair = 30,
  sym_string = 31,
  sym_interpolation = 32,
  aux_sym_source_file_repeat1 = 33,
  aux_sym_source_file_repeat2 = 34,
  aux_sym_parameters_repeat1 = 35,
  aux_sym__connection_expression_repeat1 = 36,
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == '\r' ||
          lookahead == ' ') SKIP(0)
      if (sym_identifier_character_set_1(lookahead)) ADVANCE(15);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(17);
      END_STATE();
    ...
    case 3:
      ...
      END_STATE();
    case 4:
      if (sym_escape_sequence_character_set_1(lookahead)) ADVANCE(17);
    ...
    case 15:
      ...
      if (sym_identifier_character_set_2(lookahead)) ADVANCE(15);
      END_STATE();
    case 16:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(9),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(32),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(26),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2),
  [54] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2),
  ...
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(14),
  ...
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(65),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(19),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 1),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [99] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(47),
  ...
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_expression, 4, .production_id = 3),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(31),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__connection_expression_repeat1, 2), SHIFT_REPEAT(50),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__connection_expression_repeat1, 2),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_instance, 1),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_expression, 7, .production_id = 3),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 4, .production_id = 1),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 6),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression, 1, .production_id = 2),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3),
  ...
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_value_pair, 3, .production_id = 4),
